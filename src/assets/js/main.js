  ...
  customSelects.forEach((customSelect) => {
    ...
    customOptions.addEventListener("click", (e) => {
      if (e.target.classList.contains("option")) {
        ...
        customSelect.querySelector(".Select-label").textContent =
...
function QuantityControl(container) {
  function createQuantityControl(subContainer) {
    const decreaseButton =
      subContainer && subContainer.querySelector(".decrease-button");
    const increaseButton =
      subContainer && subContainer.querySelector(".increase-button");
    const quantityInput =
      subContainer && subContainer.querySelector('input[type="number"]');
...
function Tabs(options) {
  ...
  function handlerClick(event) {
    ...
    if (clicked.classList.contains(options.tabButton)) {
      ...
      const contentIndex = clicked.closest("." + options.tabButton).dataset
        .index;
      container &&
        container
          .querySelectorAll("." + options.tabContent)
...
const sidebar = {
  ...
  toggleMobile: function () {
    const btnToggle = document.querySelector(".SideBar-header-toggle");
